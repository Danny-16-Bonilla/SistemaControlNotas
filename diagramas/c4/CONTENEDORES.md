...
El rectángulo denominado "Límite del Sistema" permite identificar cuáles componentes forman parte directamente del Sistema de Información TIC. De esta manera, el diagrama representa el flujo general:
